...
if __name__ == "__main__":
    ...
    robb_joined.add_column("SpT", onc_spt)
    ...
    matches_sv.rename(columns=lambda name: "var_" + name)
    matches_ss = ss.iloc[idx[sep_constraint & confident_members]]
    matches_ss.rename(columns=lambda name: "std_" + name)
    ...
    onc_match.lowmass = joint_matches[joint_matches['Teff'] < 3200]
    onc_match.approved = joint_matches[joint_matches['Teff'] < 3200]
